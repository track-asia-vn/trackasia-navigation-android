...
(Please use a recent commit from Jitpack see [#40](https://github.com/track-asia-vn/maplibre-navigation-android/issues/40), as the Release Build failed at Jitpack)
